...
// TODO rewrite without an inner closure
pub.juxt = juxt
function juxt () {
...
function alter (fun) {
  ...
  return function altered (value) {
    return fun(...prepend(args, value))
  }
}
...
// Alternative definition `defer(id)` breaks when called with zero arguments.
pub.val = val
function val (value) {
