...
const toArray = cond(isArray, id, isList, copyList, emptyList)

// Ignores extra args, can be safely composed.
function copyList (list) {return nslice.call(list)}
...
pub.values = cond(isArray, id, isList, copyList, isObject, objectToValues, emptyList)
