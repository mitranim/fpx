...
eq(f.isCls(),                  false)
eq(f.isCls({}),                false)
eq(f.isCls(Object),            true)
eq(f.isCls(function Cls() {}), true)
eq(f.isCls(class Cls {}),      true)
eq(f.isCls(() => {}),          false)
eq(f.isCls({}.toString),       false)
...
// Too obscure, TODO test extra args properly.
throws(f.isOpt)
throws(() => f.isOpt(null))
throws(() => f.isOpt(undefined))
throws(() => f.isOpt('str'))
eq(f.isOpt(1, f.add, -1), false)
eq(f.isOpt(1, f.add, -2), true)

throws(() => f.isListOf())
throws(() => f.isListOf([]))
throws(() => f.isListOf([], 10))
throws(() => f.isListOf([], 'str'))
eq(f.isListOf(10,             f.isStr), false)
eq(f.isListOf(null,           f.isStr), false)
eq(f.isListOf(undefined,      f.isStr), false)
eq(f.isListOf('str',          f.isStr), false)
eq(f.isListOf({},             f.isStr), false)
eq(f.isListOf([10],           f.isStr), false)
eq(f.isListOf(['one', 10],    f.isStr), false)
eq(f.isListOf(['one', 10],    f.isFin), false)
eq(f.isListOf([],             f.isStr), true)
eq(f.isListOf(['one', 'two'], f.isStr), true)
eq(f.isListOf([10, 20],       f.isFin), true)

throws(() => f.isDictOf())
throws(() => f.isDictOf({}))
throws(() => f.isDictOf({}, 10))
throws(() => f.isDictOf({}, 'str'))
eq(f.isDictOf(10,                          f.isStr), false)
eq(f.isDictOf(null,                        f.isStr), false)
eq(f.isDictOf(undefined,                   f.isStr), false)
eq(f.isDictOf('str',                       f.isStr), false)
eq(f.isDictOf([],                          f.isStr), false)
eq(f.isDictOf({one: 10},                   f.isStr), false)
eq(f.isDictOf({one: 'two', three: 10},     f.isStr), false)
eq(f.isDictOf({one: 'two', three: 10},     f.isFin), false)
eq(f.isDictOf({},                          f.isStr), true)
eq(f.isDictOf({one: 'two', three: 'four'}, f.isStr), true)
eq(f.isDictOf({one: 10,    two:   20},     f.isFin), true)
